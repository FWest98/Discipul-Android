...
public class LibsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.mikepenz.aboutlibraries.R.layout.fragment_opensource, container, false);
        // init CardView
        mRecyclerView = (RecyclerView) view.findViewById(com.mikepenz.aboutlibraries.R.id.cardListView);
