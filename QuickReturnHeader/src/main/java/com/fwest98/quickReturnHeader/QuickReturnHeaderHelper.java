package com.fwest98.quickReturnHeader;
...
public class QuickReturnHeaderHelper implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public View createView() {
        ...
        realHeaderLayoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
...
// listView.setOnScrollListener(this);
        ...
        AbsListView.LayoutParams params = new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, headerHeight);
...
// I'm aware that offsetTopAndBottom is more efficient, but it gave me trouble when scrolling to the bottom of the list
    ...
    public void onGlobalLayout() {
        if (waitingForExactHeaderHeight && dummyHeader.getHeight() > 0) {
            ...
            ViewGroup.LayoutParams params = dummyHeader.getLayoutParams();
